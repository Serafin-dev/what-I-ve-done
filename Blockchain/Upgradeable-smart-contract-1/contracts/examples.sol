...
contract TokenExchange is Initializable, ERC721UpgradeSafe, PaymentSplitterUpgradeSafe, OwnableUpgradeSafe{
        ...
        // funcion para que los usuarios minteen desde la web
        function mintNerd (uint _amount) public payable {
                
                require(_amount != 0 && _amount <= MAX_MINT_AMOUNT, "Cantidad incorrecta");

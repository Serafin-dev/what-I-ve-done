...
contract Nerdish is Initializable, ERC721UpgradeSafe, PaymentSplitterUpgradeSafe, OwnableUpgradeSafe{

        //Constructor DATA
        //payees = ["0x90F8bf6A479f320ead074411a4B0e7944Ea8c9C1","0xFFcf8FDEE72ac11b5c542428B35EEF5769C409f0"]
        //shares_ = [50, 50]

        //private array to hold wallet addresses.
        ...
        //constructor
        function initialize( string memory _name, string memory _symbol, address[] memory _payees, uint256[] memory _shares) public payable initializer{
        ...
        function mintNerd (uint _amount) public payable {
                ...
                for (uint256 _id = totalSupply() + 1; _id <= _amount; _id ++){
        ...
        function pullPayment () public onlyAdmins returns(address){
